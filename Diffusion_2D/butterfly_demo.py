...
if __name__ == "__main__":
    ...
    # dataset = dataset_brats_2D.Train_Dataset(r"E:\HLX\PythonProject\Diffusion_2D_BraTS\BraTS2020_2D\flair")
    ...
    # print(noise.shape)
    # noisy_xb = noise_scheduler.add_noise(image,noise,timesteps)
    # print(noisy_xb.shape)
    model = model.model().to(device)
    # with torch.no_grad():
    #     model_prediction = model(noisy_xb.to(device),timesteps).sample
