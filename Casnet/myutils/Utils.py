...
def get_train_directory(args):
    ...
    kspace_dir = 'D:/科研/knee_self_supervised/singlecoil_train/kspace.h5'

    mask_dir = 'kspace.mat'

    theta_lambda_mask_dir='D:/科研/knee_self_supervised/singlecoil_train/n2n_mask.h5'

    return kspace_dir, mask_dir, theta_lambda_mask_dir
...
def getSSIM(space_ref, space_rec):
    ...
    return measure.compare_ssim(space_rec, space_ref, data_range=data_range,
...
def sense1(input_kspace, axes=(0, 1)):
    """
    Parameters
    ----------
